...
$cekfirst = mysql_query ("SELECT id, panggil, loket FROM tbl_bpjs_rajal where loket = 3 and panggil = 2 limit 1");
$shwfirst = mysql_fetch_array ($cekfirst);
$cek = mysql_query ("SELECT id, panggil, loket FROM tbl_bpjs_rajal where loket = 3 and panggil = 1 order by id desc limit 1");
